...
import static com.example.Midnight.Snacker.apiPayload.code.status.ErrorStatus.AUTH_INVALID_TOKEN;
import static com.example.Midnight.Snacker.apiPayload.code.status.ErrorStatus.USER_NOT_FOUND;
